...
//        Komanda: locust -f login_stress_test.py -u 1000 -r 5  -t 100 --headless –host  https://cms.demo.katalon.com/ --html login_stress_report.html
        ...
        String komanda = "locust -f $LOCUSTFILE -u $NUMBER_OF_USERS -r $SPAWN_RATE" +
                " -t $RUN_TIME --headless –host $HOST --html $HTML_FILE";
        String recZaZamenu, zamena;
        while(komanda.contains("$")){
            ...
            zamena = s.next();
            komanda = komanda.replace(recZaZamenu, zamena);
        }
