...
//U glavnom programu kreirati jednu Korpu i u nju dodati nekoliko Ambalaza razlicitih tipova i istestirati sve metode i ispisati ukupnu cenu sa popustom.
    ...
    public static void main(String[] args) {
        ...
        SuperKartica kartica = new SuperKartica(120, "Marko Markovic", 20);
        StaklenaAmbalaza ambalaza = new StaklenaAmbalaza("253636", "Sirup ", 70, 90, 0, false, 200);

        korpa.dodajAmbalazu(new Tetrapak("2727373", "Jogurt", 90, 70, true, 220));
        korpa.dodajAmbalazu(new StaklenaAmbalaza("6886868", "Sok", 60, 70, 40, true, 150));
        korpa.dodajAmbalazu(new Tetrapak("6886868", "Mleko", 100, 150, false, 200));
